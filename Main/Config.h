...
#define THROW_MIN_FLIGHT_MS 120UL
#define THROW_MIN_IMPACT_DELAY_MS 40UL
#define THROW_CLEAN_LOW_G_THRESHOLD 0.28f
#define THROW_SPIN_DPS 280.0f
#define THROW_MIN_SPIN_MS 50UL
#define THROW_SPIN_MAX_G 2.50f
#define THROW_SPIN_RELEASE_G 1.80f
#define THROW_SPIN_MIN_LOW_G_MS 40UL
#define THROW_STRONG_SPIN_DPS 700.0f
#define THROW_MIN_STRONG_SPIN_MS 40UL
#define THROW_STRONG_SPIN_MAX_G 3.00f
#define THROW_STRONG_SPIN_RELEASE_G 2.20f
#define THROW_IMPACT_G 1.5f
#define THROW_IMPACT_RISE_G 0.35f
#define THROW_HARD_IMPACT_G 3.20f
#define THROW_IMPACT_WINDOW_MS 2500UL
